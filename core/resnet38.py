...
class ResNet38:
    ...
    def _build_model(self, image, is_train=False):
        ...
        shape_dict['B7'] = [[1,1,256,256],[3,3,256,256],[1,1,256,512]]
	...
	print("Built model complete. Number of parameters: {0}".format(self._num_params))
